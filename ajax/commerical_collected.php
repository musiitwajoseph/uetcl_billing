...
echo '<h4>TeaTrak: Collection of Commercial Invoice: '.$com_number.'</h4>';
?>

<div class="col-lg-3">
	<div class="form-group">
		<label>Despatch Note<span class="must">*</span></label>
		<div class="form-line">
			<input type="text" class=" form-control" value="" id="despatchNotec"/>
		</div>
	</div>
</div>
<div class="col-lg-3">
	<div class="form-group">
		<label>Vehicle Nos.<span class="must">*</span></label>
		<div class="form-line">
			<input type="text" class=" form-control" value="" id="vehicleNumberc"/>
		</div>
	</div>
</div>
...
<div class="col-lg-2">
	<div class="form-group">
		<label>Collected By<span class="must">*</span></label>
		<div class="form-line">
			<select name="from" class="form-control select3" id="collectedByChanged">
				<option value="" > Select </option>
				<?php
				$select = $db->select("SELECT * FROM valid_names WHERE category = '2006' ORDER BY name ASC");//FACTORY
...
<div class="col-lg-3">
	<div class="form-group">
		<label>Collected On<span class="must">*</span></label>
		<div class="form-line">
			<input type="date" class=" form-control" value="<?php echo date('Y-m-d'); ?>" id="collectedOnc"/>
		</div>
	</div>
</div>
<div class="row">
		...
		<div style="border:1px solid #ccc; padding:10px;margin-bottom:10px;">
			<div class="row">
				...
				<div class="col-lg-3">
					...
					<input type="hidden" value="<?php echo $com_id ?>" id="commericalInvoiceNumber"/>
				</div>
				<div class="col-lg-2">
					VAT (%)
...
foreach($select[0] as $row){
	...
	echo '<td align="right"><span id="sold'.$i.'">For Collection</span></td>';
